...
const projects = [
  {
    ...
    dataReadiness: "Veeva CRM customer contact list and past campaign click-through rates are clean, indexed, and accessible.",
    ...
    deploymentGateway: "http://oncology-omnichannel.company.internal",
    phase: "Ready",
  ...
  },
  {
    ...
    dataReadiness: "Historical vaccine sales records, regional distributor shipping logs, and CDC infection trends data are ingested.",
    ...
    deploymentGateway: "http://vaccine-predictive.company.internal",
    phase: "Working",
  ...
  },
  {
    ...
    dataReadiness: "Electronic health record registries and patient claim databases have been anonymized and pre-processed.",
    ...
    deploymentGateway: "http://rare-patient-id.company.internal",
    phase: "Scheduled",
    budgetAvailabilityScore: 100.0,
  ...
  },
  {
    ...
    dataReadiness: "Veeva CRM field rep call logs and physician interaction histories are synced and available in the local database.",
    financialRoi: 450000.0,
    budgetRequiredVal: 150000.0,
    execSponsor: "Thomas Wright, Head of Vaccines Commercial",
    productOwner: "Jessica Martinez, Field Force Coordinator",
    deploymentGateway: "http://field-force-recommender.company.internal",
    phase: "Backlog",
  ...
  },
  {
    ...
    dataReadiness: "Electronic health records and historical diagnostic claim codes are fully mapped and cleaned.",
    financialRoi: 680000.0,
    budgetRequiredVal: 200000.0,
    execSponsor: "Dr. Angela Vance, VP Oncology Marketing",
    productOwner: "Sarah Jenkins, Product Director",
    deploymentGateway: "http://immuno-journey.company.internal",
    phase: "Working",
    budgetAvailabilityScore: 85.0,
  ...
  },
  {
    ...
    dataReadiness: "A marketing asset catalog and GP unsubscribe lists are available and structured in Salesforce.",
    financialRoi: 410000.0,
    budgetRequiredVal: 130000.0,
    execSponsor: "Linda Hsieh, VP Rare Diseases",
    productOwner: "Marcus Broady, Senior Brand Manager",
    deploymentGateway: "http://im-personalization.company.internal",
    phase: "Ready",
  ...
  },
  {
    ...
    dataReadiness: "National claims databases are historic and cleared of any identifiers; ready for co-prescription parsing.",
    financialRoi: 310000.0,
    budgetRequiredVal: 90000.0,
    execSponsor: "Thomas Wright, Head of Vaccines Commercial",
    productOwner: "Marcus Broady, Senior Brand Manager",
    deploymentGateway: "http://vaccines-coadmin.company.internal",
    phase: "Backlog",
  ...
  },
  {
    ...
    dataReadiness: "Genomic screening panel data and metabolic patient registers are cleaned, structured, and ready.",
    financialRoi: 1500000.0,
    budgetRequiredVal: 400000.0,
    execSponsor: "Linda Hsieh, VP Rare Diseases",
    productOwner: "Ryan Patel, Commercial Lead",
    deploymentGateway: "http://rare-screening-id.company.internal",
    phase: "Scheduled",
    budgetAvailabilityScore: 100.0,
    dataAvailabilityScore: 90.0,
    stakeholderReadinessScore: 95.0,
  ...
  },
  {
    ...
    dataReadiness: "Field representative interaction logs, email open histories, and rep response rates are synced from Veeva.",
    financialRoi: 490000.0,
    budgetRequiredVal: 160000.0,
    execSponsor: "Thomas Wright, Head of Vaccines Commercial",
    productOwner: "Marcus Broady, Senior Brand Manager",
    deploymentGateway: "http://im-next-best-action.company.internal",
    phase: "Ready",
